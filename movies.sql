...
-- 	**movies_group**			**movies_info**				 **genre_table**
-- 	-----------------			-----------------			-----------------
-- 	| ID (PK)		| <---|		| ID (PK)		|			|  ID (PK)		|
-- 	-----------------	  |		-----------------			-----------------
-- 	| MOVIES		|	  |     | RATING		|			|  GENRE		|
--  -----------------	  |		-----------------			-----------------
-- 	| start_year	|	  |		| ONELINE		|	  |----	|  movie_id()FK	|
-- 	-----------------	  |		-----------------	  |		-----------------
-- 	| end_year		|	  |		| STARS			|	  | 	
-- 	-----------------     |		-----------------	  |	
-- 	| Gross			|	  |		| VOTES			|	  |
...
-- 	**movies**	  		  |		  **critics**				    **genre**			 	      **director**			   |
-- 	-----------------	  |		-----------------			-----------------			--------------------------     |		
-- 	| ID (PK)		| <---|		| ID (PK)		|			|  ID (PK)		|			|  ID (PK)				 |     |
-- 	-----------------	  |		-----------------			-----------------			--------------------------     |
-- 	| MOVIES		|	  ^     | RATING		|			|  GENRE		|			|  Directors			 |     |
--  -----------------	  |		-----------------			-----------------			--------------------------     |
-- 	| start_year	|	  |		| ONELINE		|	  |----	|  movie_id(FK)	|	  |-----|  director_movie_id(FK) |     |
-- 	-----------------	  |		-----------------	  |		-----------------	  |		--------------------------	   |
-- 	| end_year		|	  |		| VOTES			|	  ν 						  |		|  director_info_id(FK)  |-----|
-- 	-----------------     |		-----------------	  |<--------------------------|		--------------------------
-- 	| Gross			|	  |		| RunTime		|	  ν
-- 	-----------------	  ^		-----------------	  |
--						  |---- | movie_id(FK)	|     |
